...
**Vibe:** Warm, minimal, human, confident simplicity, approachable expertise

**Typography:**
- Display: `Zodiak` (700) or `Freight Display` — Bold serif with personality (not cold/corporate)
- Body: `Satoshi` (400/500) — Clean sans-serif, modern warmth

**Colors:**
```css
:root {
    --bg-primary: #F5F3ED;       /* Warm cream (not stark white) */
    --bg-secondary: #E8E5DC;     /* Muted sage for cards */
    --text-primary: #131314;     /* Near-black */
    --text-secondary: #87867F;   /* Warm gray */
    --accent: #D97757;           /* Terracotta (human/earthy, not tech-blue) */
    --accent-soft: rgba(217, 119, 87, 0.1);
}
```

**Signature Elements:**
- Extreme restraint — every element has purpose
- Generous whitespace between elements
- Cards with soft sage backgrounds, no harsh borders
- Asymmetric balance — intentionally placed, not perfectly centered
- Organic, hand-drawn feel illustrations if any (nature-inspired, abstract forms)
- No busy patterns — solid colors, simple shapes
- Terracotta accent used sparingly but confidently

**What Makes It "Anthropic":**
- Warm cream instead of stark white
- Terracotta accent (human/earthy, not tech-blue)
- Hand-drawn illustrations feel approachable
- Confident simplicity — says a lot with very little
- Minimalist but warm — nothing cluttered

**Animation Style:**
- Gentle, confident (0.5-0.7s)
- Subtle fade + slight rise entrances
- No dramatic movements
- Refined restraint throughout

**DO NOT include:**
- Neon colors or tech-blue
- Harsh borders or heavy shadows
...
| Anthropic/Claude | Zodiak | Satoshi | Fontshare |
